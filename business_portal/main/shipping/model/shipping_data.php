...
function add_shipping_order($v1,$v2,$v3,$v4,$v5,$v6,$v7,$v8,$v9,$v10,$v11,$v12,$v13,$v14) {
  //echo "mst: $v1, senddt: $v2, airportdt: $v3, total wt:  $v4, no_packages:$v5, value: $v6, custom fee:  $v7, insurance: $v8,  payment_method: $v9, user_id`: $v10, location: $v11, customer_id:  $v12,recipient_id: $v13, price_per_lb: $v14";
  echo "<br>Start Add Ship ORd<br>"; 
  global $db;
  $query = 'INSERT INTO `shipping_order`(`mst`, `send_date`, `airport_delivery_date`, `total_weight`, `num_of_packages`, `package_value`, `custom_fee`, `insurance`, `payment_method`, `user_id`, `location`, `customer_id`, `recipient_id`, `price_per_lb`) VALUES (:v1,:v2,:v3,:v4,:v5,:v6,:v7,:v8,:v9,:v10,:v11,:v12,:v13,:v14)'; 
  $stmt = $db->prepare($query);
  $res = $stmt->execute(array(
     ':v1' => $v1,
     ':v2' => $v2,
...
echo "shiporderid: $shipping_ord_id<br>";
  ...
  for ($i = 0; $i < count($packages); $i++) {
    $query = 'INSERT INTO `package`(`shipping_order_id`, `package_desc`, `package_weight`, `mst`) VALUES (:v1,:v2,:v3,:v4);';
    $stmt = $db->prepare($query);
    $res = $stmt->execute(array(
      ':v1' => $shipping_ord_id,
