...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/chosen/1.4.2/chosen.css" /> from shipping/index.php-->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
...
<?php include '../../navfixed.php';?>
	<nav class="navbar-primary sticky">
      ...
      <li><a href="shipping_form.php" class="nav-link text-white active"> > Tạo Đơn Gửi Hàng (Shipping Form)</a></li>
    ...
    <div class="container center">
      <div class="row">
        ...
        <div class="col-6">
          ...
          <div class="item">
              ...
              <input id="phone" type="tel"  name="cust_phone" value="<?=$customer[0]['cust_phone']?>" required/>
            </div>
            <div class="item">
        ...
        <div class="item hidden" id="recipient_form">
          <form action="./index.php" method="post">
            ...
            <div class="item">
              ...
              <input id="recipient_phone" type="text" id="recipient_phone"  name="recipient_phone"/>
            </div>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="row">
            <div class="item col-6">
              <label class="fw-bold">Total Payment</label>
            </div><!--col-6-->
            <div class="item col-6">
